      ...
      <div className={nav
        ...
        <nav>
          <ul className='flex flex-col p-4 text-gray-800'>
            ...
            <li className='text-xl py-4 flex'><BsFillSafeFill className='mr-4' size={25}/> Best Ones</li>
            <li className='text-xl py-4 flex'><FaUserFriends className='mr-4' size={25}/> Invite Friend</li>
          </ul>
        </nav>
      </div>
    </div>
