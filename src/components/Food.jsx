  ...
  return (
    <div className='max-w-[1640px] m-auto px-4 py-12'>
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div>
          ...
          <div className='flex justify-between max-w-[390px] w-full'>
            <button onClick={() => priceFilter('$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$</button>
            <button onClick={() => priceFilter('$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$$</button>
            <button onClick={() => priceFilter('$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$$$</button>
            <button onClick={() => priceFilter('$$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$$$$</button>
          </div>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4'>
        {food.map((item, i) =>(
          <div className='border shadow-lg rounded-lg hover:scale-105 duration-300' key={i}>
